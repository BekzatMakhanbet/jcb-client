...
var list=[
    ...
    {cat:2,image:"./img/2/1.jpg",name:'1CXT',f_col:'Глубина копания',s_col:'Масса',t_col:'Объём ковша', first:'3080 мм',second:'4342 кг',third:'0.36 м3',text:'Экскаваторы-погрузчики'},
    {cat:2,image:"./img/2/2.jpg",name:'1CХ',f_col:'Глубина копания',s_col:'Масса',t_col:'Объём ковша', first:'3080 мм',second:'3228 кг',third:'0.31 м3',text:'Экскаваторы-погрузчики'},
            ...
            <div className="list-page">
                ...
                <div className="list">
                    <div className="list-elem">
                        <Link to="/about-us"><div className="list-title">О компании</div></Link>
                    </div>

                    <div className="list-elem">
                    <Link to="/contacts"><div className="list-title">Контакты</div></Link>
                    </div>

                    <div className="list-elem">
                    <Link to="/news"> <div className="list-title">Акции и Новости</div></Link>
                    </div>
                    <div className="list-elem">
                    <Link to="/finance"><div className="list-title">Финансирование</div></Link>
                    </div>
                    <div className="list-elem">
                    <Link to="/parts"> <div className="list-title">Запчасти и Сервис</div></Link>
                    </div>
                    <div className="list-elem">
                    <Link to="/parts"> <div className="list-title">Live Link</div></Link>
                    </div>
                    <div className="list-elem">
                    <Link to="/catalog"> <div className="list-title">Каталог</div></Link>
                        <div className="sublist-cont">
                        {cat_list.map(cat=>(
                            <div>
                            <Link to={"/catalog/"+cat.index}><div className="list-sublists">{cat.name}</div></Link>
                            {list.filter(car=> car.cat===cat.index).map((car,index)=>(
                                car.cat===cat.index && <Link to={"/catalog/"+cat.index+"/"+(index+1)}><div className="sublist-subs">{car.name}</div></Link>
                            ))}
                            </div>
                        ))}
                        </div>
